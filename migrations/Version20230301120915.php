 ...
 */
final class Version20230301120915 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE oders_details ADD CONSTRAINT FK_74FEBBCF6C8A81A9 FOREIGN KEY (products_id) REFERENCES product (id)');
